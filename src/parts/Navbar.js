        ...
        <div className="flex flex-row justify-between px-10 lg:px-20 py-5">
          ...
          <a href="https://www.linkedin.com/in/hazlanmqodri/">
            <h1
              ...
              className={classNames(
                scrollPosition < 100 && location.pathname === "/"
                  ? "text-black text-5xl font-extrabold tracking-wide drop-shadow-lg shadow-black"
                  : "hidden"
              )}
            >
              SUMBERJO
          ...
          <a href="https://www.linkedin.com/in/hazlanmqodri/">
            <h1
              ...
              className={classNames(
                scrollPosition >= 100 && location.pathname === "/"
                  ? "text-5xl font-extrabold tracking-wide drop-shadow-lg shadow-black"
                  : "hidden"
              )}
            >
              SUMBERJO
          ...
          {/* sidebar mobile */}
          <ul
            className="sidebar lg:hidden bg-white text-black shadow fixed flex flex-col justify-start items top-0 bottom-0 -right-80 w-80 z-30 px-5 font-bold hover:text-blue"
            id="navUl"
          >
            <li className="py-4 mt-20">
            ...
            <li className="py-4">
              <a href="#techstack" className="mr-5">
                Tech Stack
              </a>
            </li>
            <li className="py-4">
              <a href="#tools" className="mr-5">
                Tools
              </a>
            </li>
            <li className="py-4">
            ...
            <li className="py-4">
              <a href="#photos" className="mr-5">
                Photos
              </a>
            </li>
            <li className="py-4">
              <a
                href="https://linktr.ee/hzlnqodrey"
                className="bg-blue1 text-white rounded-full py-2 px-5"
              >
                Other socials
              </a>
            </li>
          ...
          <ul className="hidden lg:flex items-center">
            ...
            <li>
              <a
                href="#experience"
                className={classNames(
                  scrollPosition >= 700 && scrollPosition < 1400
                    ? "font-bold text-horizon-text1"
                    : "font-normal",
                  "mr-5"
                )}
            ...
            <li>
              <a
                href="#techstack"
                className={classNames(
                  scrollPosition >= 1400 && scrollPosition < 2100
                    ? "font-bold text-horizon-text1"
                    : "font-normal",
                  "mr-5"
                )}
            ...
            <li>
              <a
                href="#tools"
                className={classNames(
                  scrollPosition >= 2100 && scrollPosition < 3000
                    ? "font-bold text-horizon-text1"
                    : "font-normal",
                  "mr-5"
                )}
            ...
            <li>
              <a
                href="#photos"
                className={classNames(
                  scrollPosition >= 3600 && scrollPosition < 4500
                    ? "font-bold text-horizon-text1"
                    : "font-normal",
                  "mr-5"
                )}
